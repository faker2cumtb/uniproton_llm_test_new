...
#define PHY_ADIN1200_SPECIFIC_STATUS_REG 0x1A
#define PHY_ADIN1200_SPECIFIC_STATUS_SPEED_100M (1L << 8)   // 1:100M, 0:10M
#define PHY_ADIN1200_SPECIFIC_STATUS_FULL_DUPLEX (1L << 7)  // 1:Full Duplex, 0:Half Duplex
#define PHY_ADIN1200_SPECIFIC_STATUS_LINK_UP (1L << 6)      // 1:Link Up, 0:Link Down
