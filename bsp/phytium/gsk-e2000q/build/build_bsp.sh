...
copy_headers "../../common/hal/common" "../include/hal"
copy_headers "../../common/hal/fiopad" "../include/hal"
copy_headers "../../common/hal/port" "../include/hal"
copy_headers "../../common/drv" "../include/drv"
