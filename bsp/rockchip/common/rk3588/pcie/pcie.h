...
#define PCI_BDF(b, d, f) ((((b) & 0xff) << 8U) | (((d) & 0x1f) << 3U) | ((f) & 0x7))
#define PCI_BUS(bdf) (((bdf) >> 8U) & 0xff)
#define PCI_DEV(d)  (((d) >> 3U) & 0x1f)
#define PCI_DEVFN_FROM_BDF(bdf) ((bdf) & 0xff)

#define PCI_DEVFN(slot, func)   ((((slot) & 0x1f) << 3U) | ((func) & 0x07))
#define PCI_SLOT(devfn) (((devfn) >> 3U) & 0x1f)
#define PCI_FUNC(devfn) ((devfn) & 0x07)

#define PCI_MASK_BUS(bdf)	       ((bdf) & 0xffff)
#define PCI_ADD_BUS(bus, devfn)	   (((bus) << 16) | (devfn))

#define PCI_CFGPDF_TO_BDF(bdf) ((bdf) >> 8U)
