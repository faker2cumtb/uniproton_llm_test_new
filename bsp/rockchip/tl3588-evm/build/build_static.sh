...
[ -d $INC_DIR/net ] || mkdir $INC_DIR/net
cp -a src/net/adapter/include/* $INC_DIR/net
cp -a src/net/lwip_port/* $INC_DIR/net
...
[ -d $INC_DIR/om ] || mkdir $INC_DIR/om
cp -a src/om/include/*.h $INC_DIR/om

[ -d $INC_DIR/mem ] || mkdir $INC_DIR/mem
cp -a src/mem/include/*.h $INC_DIR/mem

cp -r src/net/lwip/src/include/* $INC_DIR
...
if [ -d "output/ethercat/include" ] ; then
    cp -r output/ethercat/include/* $INC_DIR
fi
