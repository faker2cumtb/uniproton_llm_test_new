...
cpus_ = {'all': ['clean', 'm4', 'raspi4', 'hi3093', 'atlasa1', 'kp920', 'x86_64', 'rk3568','rk3588', 'ascend310b', 'uvp', 'rv64virt', 'ds-d1s', 'e2000q', 'd9340_secure'],
         'clean': ['clean'],
         'm4': ['m4'],
         'raspi4': ['raspi4'],
         'hi3093': ['hi3093'],
