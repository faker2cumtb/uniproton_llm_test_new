...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1016_consumerHeartbeatTime = {0x00072EE0, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000},
    .x1017_producerHeartbeatTime = 0x2710,
    .x1018_identity = {
    ...
    .x1019_synchronousCounterOverflowValue = 0x08,
    ...
    .x6001_rxPdo = 0x00000000,
    .x6002_txPdo = 0x00000000,
    .x6003_rxSdoSrv = 0x00000000,
    .x6004_txSdoSrv = 0x00000000,
    .x6005_rxSdoCli = 0x00000000,
    .x6006_txSdoCli = 0x00000000
};
...
typedef struct {
    ...
    OD_obj_var_t o_6001_rxPdo;
    OD_obj_var_t o_6002_txPdo;
    OD_obj_var_t o_6003_rxSdoSrv;
    OD_obj_var_t o_6004_txSdoSrv;
    OD_obj_var_t o_6005_rxSdoCli;
    OD_obj_var_t o_6006_txSdoCli;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_6001_rxPdo = {
        .dataOrig = &OD_PERSIST_COMM.x6001_rxPdo,
        .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
        .dataLength = 4
    },
    .o_6002_txPdo = {
        .dataOrig = &OD_PERSIST_COMM.x6002_txPdo,
        .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
        .dataLength = 4
    },
    .o_6003_rxSdoSrv = {
        .dataOrig = &OD_PERSIST_COMM.x6003_rxSdoSrv,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataLength = 4
    },
    .o_6004_txSdoSrv = {
        .dataOrig = &OD_PERSIST_COMM.x6004_txSdoSrv,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataLength = 4
    },
    .o_6005_rxSdoCli = {
        .dataOrig = &OD_PERSIST_COMM.x6005_rxSdoCli,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataLength = 4
    },
    .o_6006_txSdoCli = {
        .dataOrig = &OD_PERSIST_COMM.x6006_txSdoCli,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataLength = 4
    }
};
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x6001, 0x01, ODT_VAR, &ODObjs.o_6001_rxPdo, NULL},
    {0x6002, 0x01, ODT_VAR, &ODObjs.o_6002_txPdo, NULL},
    {0x6003, 0x01, ODT_VAR, &ODObjs.o_6003_rxSdoSrv, NULL},
    {0x6004, 0x01, ODT_VAR, &ODObjs.o_6004_txSdoSrv, NULL},
    {0x6005, 0x01, ODT_VAR, &ODObjs.o_6005_rxSdoCli, NULL},
    {0x6006, 0x01, ODT_VAR, &ODObjs.o_6006_txSdoCli, NULL},
