...
typedef struct {
    ...
    uint32_t x6001_rxPdo;
    uint32_t x6002_txPdo;
    uint32_t x6003_rxSdoSrv;
    uint32_t x6004_txSdoSrv;
    uint32_t x6005_rxSdoCli;
    uint32_t x6006_txSdoCli;
} OD_PERSIST_COMM_t;
...
#define OD_ENTRY_H6001_rxPdo &OD->list[35]
#define OD_ENTRY_H6002_txPdo &OD->list[36]
#define OD_ENTRY_H6003_rxSdoSrv &OD->list[37]
#define OD_ENTRY_H6004_txSdoSrv &OD->list[38]
#define OD_ENTRY_H6005_rxSdoCli &OD->list[39]
#define OD_ENTRY_H6006_txSdoCli &OD->list[40]
