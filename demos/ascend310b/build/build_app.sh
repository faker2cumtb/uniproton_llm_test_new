# UniProton_test_proxy_posix_interface ascend310b UniProton_test_log_interface UniProton_test_posix_time_interface
...
echo "cmake start"
cmake -S .. -B $TMP_DIR -DAPP:STRING=$APP -DTOOLCHAIN_PATH:STRING=$TOOLCHAIN_PATH -DCPU_TYPE:STRING="ascend310b"
echo "cmake end"
