...
# task-switch task-preempt semaphore-shuffle interrupt-latency deadlock-break message-latency linuxTest UniProton_test_proxy_posix_interface
export ALL="kp920"
...
function build()
{
    ...
    cmake -S .. -B $TMP_DIR -DAPP:STRING=$APP -DTOOLCHAIN_PATH:STRING=$TOOLCHAIN_PATH -DCPU_TYPE:STRING="armv8"
    pushd $TMP_DIR
    make $APP
    popd
