...
# x86_64 UniProton_test_posix_time_interface UniProton_test_proxy_posix_interface UniProton_test_libxml2_interface
...
function build()
{
    ...
    cmake -S .. -B $TMP_DIR -DAPP:STRING=$APP -DTOOLCHAIN_PATH:STRING=$TOOLCHAIN_PATH -DCPU_TYPE:STRING="x86_64" -DCMAKE_C_COMPILER=$TOOLCHAIN_PATH/bin/x86_64-openeuler-linux-gnu-gcc -DCMAKE_CXX_COMPILER=$TOOLCHAIN_PATH/bin/x86_64-openeuler-linux-gnu-g++
    pushd $TMP_DIR
    make $APP
    popd
