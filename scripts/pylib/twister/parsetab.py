...
_lr_productions = [
  ...
  ('expr -> expr OR expr','expr',3,'p_expr_or','expr_parser.py',110),
  ('expr -> expr AND expr','expr',3,'p_expr_and','expr_parser.py',114),
  ('expr -> NOT expr','expr',2,'p_expr_not','expr_parser.py',118),
  ('expr -> OPAREN expr CPAREN','expr',3,'p_expr_parens','expr_parser.py',122),
  ('expr -> SYMBOL EQUALS const','expr',3,'p_expr_eval','expr_parser.py',126),
  ('expr -> SYMBOL NOTEQUALS const','expr',3,'p_expr_eval','expr_parser.py',127),
  ('expr -> SYMBOL GT number','expr',3,'p_expr_eval','expr_parser.py',128),
  ('expr -> SYMBOL LT number','expr',3,'p_expr_eval','expr_parser.py',129),
  ('expr -> SYMBOL GTEQ number','expr',3,'p_expr_eval','expr_parser.py',130),
  ('expr -> SYMBOL LTEQ number','expr',3,'p_expr_eval','expr_parser.py',131),
  ('expr -> SYMBOL IN list','expr',3,'p_expr_eval','expr_parser.py',132),
  ('expr -> SYMBOL COLON STR','expr',3,'p_expr_eval','expr_parser.py',133),
  ('expr -> SYMBOL','expr',1,'p_expr_single','expr_parser.py',137),
  ('expr -> SYMBOL OPAREN arg_intr CPAREN','expr',4,'p_func','expr_parser.py',141),
  ('arg_intr -> const','arg_intr',1,'p_arg_intr_single','expr_parser.py',146),
  ('arg_intr -> arg_intr COMMA const','arg_intr',3,'p_arg_intr_mult','expr_parser.py',150),
  ('list -> OBRACKET list_intr CBRACKET','list',3,'p_list','expr_parser.py',155),
  ('list_intr -> const','list_intr',1,'p_list_intr_single','expr_parser.py',159),
  ('list_intr -> list_intr COMMA const','list_intr',3,'p_list_intr_mult','expr_parser.py',163),
  ('const -> STR','const',1,'p_const','expr_parser.py',168),
  ('const -> number','const',1,'p_const','expr_parser.py',169),
  ('number -> INTEGER','number',1,'p_number','expr_parser.py',173),
  ('number -> HEX','number',1,'p_number','expr_parser.py',174),
]
