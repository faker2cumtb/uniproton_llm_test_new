...
extern uintptr_t OsGetLogBufferCfg();

extern void setLogBufInitState();

#else

#define PRT_Log(level, facility, str, strLen)
#define PRT_LogFormat(...)
#define PRT_LogInit(memBase)
#define PRT_LogOn()
#define PRT_LogOff()
#define PRT_LogSetFilter(level)
#define PRT_LogSetFilterByFacility(facility, level)
